...
const PRODUCT_STATIC: ProductStatic[] = [
  {
    code: "ASP-RO", accent: "green", image: "/images/P01.jpg", thickness: "30–200mm",
    specs: [{ label: "λD", value: "0.022 W/m·K" }, { label: "Fire", value: "BS1D0 / BS2D0" }, { label: "Width", value: "1000mm" }],
  },
  {
    code: "ASP-WA", accent: "blue", image: "/images/P02.jpg", thickness: "40–150mm",
    specs: [{ label: "λD", value: "0.022 W/m·K" }, { label: "Uc", value: "from 0.15 W/m²K" }, { label: "Width", value: "1000mm" }],
  },
  {
    code: "ASP-SF", accent: "purple", image: "/images/P03.jpg", thickness: "40–200mm",
    specs: [{ label: "Fix", value: "Concealed" }, { label: "Surface", value: "Ultra-smooth" }, { label: "Fire", value: "BS1D0" }],
  },
  {
    code: "ASP-CS", accent: "ice", image: "/images/P04.jpg", thickness: "60–200mm",
    specs: [{ label: "Temp", value: "-40°C to +15°C" }, { label: "Edge", value: "4-layer T&G" }, { label: "HACCP", value: "Compliant" }],
  },
  {
    code: "ASP-CR", accent: "ice", image: "/images/P05.jpg", thickness: "50–150mm",
