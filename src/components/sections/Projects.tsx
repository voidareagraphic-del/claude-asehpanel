    ...
    >
      ...
      <div className="absolute inset-0">
        {project.image ? (
          ...
          <div style={{ background: project.size === "large" ? `linear-gradient(135deg, #0E1420 0%, #141C28 60%, #0A1018 100%)` : `linear-gradient(135deg, #101418 0%, #181C20 100%)` }} className="absolute inset-0" />
        )}
        {/* Accent color glow */}
        <div
